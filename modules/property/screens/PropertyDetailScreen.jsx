...
export default function PropertyDetailScreen({ navigation, onBack }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.propertyHeader}>
          ...
          <View style={styles.addressRow}>
            ...
            <Text style={styles.address}>
              1245 Sunset Boulevard, Beverly Hills, CA 90210
            </Text>
          </View>
        ...
        <View style={styles.specsSection}>
          <View style={styles.specsGrid}>
            <SpecCard
              icon={<Bed size={24} color="#2D6A4F" strokeWidth={2} />}
              label="Bedrooms"
              value="4"
            />
            <SpecCard
              icon={<Bath size={24} color="#2D6A4F" strokeWidth={2} />}
              label="Bathrooms"
              value="3"
            />
            <SpecCard
              icon={<Maximize size={24} color="#2D6A4F" strokeWidth={2} />}
              label="Area"
              value="3,400"
            />
            <SpecCard
              icon={<Calendar size={24} color="#2D6A4F" strokeWidth={2} />}
              label="Built"
              value="2021"
            />
          </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.description}>
            Step into luxury with this stunning modern villa located in the
            heart of Beverly Hills. This architectural masterpiece features an
            open floor plan with floor-to-ceiling windows that flood the space
            with natural light. The gourmet kitchen boasts high-end appliances,
            custom cabinetry, and a large island perfect for entertaining.
          </Text>
          <Text style={[styles.description, styles.descriptionSpaced]}>
            The master suite includes a spa-like bathroom and private balcony
            with breathtaking views. Outside, enjoy the resort-style pool,
            outdoor kitchen, and beautifully landscaped gardens. This home is
            the epitome of California luxury living.
          </Text>
        </View>
        ...
        <View style={styles.featuresSection}>
          ...
          <View style={styles.featuresGrid}>
            <FeatureChip
              icon={<Droplet size={16} color="#2D6A4F" strokeWidth={2} />}
              label="Pool"
            />
            <FeatureChip
              icon={<Car size={16} color="#2D6A4F" strokeWidth={2} />}
              label="3-Car Garage"
            />
            <FeatureChip
              icon={<Flame size={16} color="#2D6A4F" strokeWidth={2} />}
              label="Fireplace"
            />
            <FeatureChip
              icon={<Wifi size={16} color="#2D6A4F" strokeWidth={2} />}
              label="Smart Home"
            />
            <FeatureChip
              icon={<Dumbbell size={16} color="#2D6A4F" strokeWidth={2} />}
              label="Home Gym"
            />
            <FeatureChip
              icon={<Trees size={16} color="#2D6A4F" strokeWidth={2} />}
              label="Garden"
            />
            <FeatureChip
              icon={<ShieldCheck size={16} color="#2D6A4F" strokeWidth={2} />}
              label="Security System"
            />
            <FeatureChip
              icon={<Video size={16} color="#2D6A4F" strokeWidth={2} />}
              label="Home Theater"
            />
          </View>
        </View>
      ...
      <View style={styles.bottomCTA}>
        <View style={styles.ctaRow}>
          <TouchableOpacity style={styles.ctaButtonGreen}>
