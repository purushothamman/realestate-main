      ...
      >
        ...
        {notif.property && (
          <>
            ...
            <View style={detS.propCard}>
              {(notif.property.image || notif.property.propImage)
                ? <Image source={{ uri:notif.property.image||notif.property.propImage }} style={[detS.propImg, { height:imgH }]} resizeMode="cover" />
                : <View style={[detS.propImg, { height:imgH, backgroundColor:T.n200, justifyContent:'center', alignItems:'center' }]}><Home color={T.n400} size={40} strokeWidth={1.5}/></View>
              }
              <View style={detS.propScrim} />
              {notif.property.type && (
